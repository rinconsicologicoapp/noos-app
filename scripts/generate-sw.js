...
// Firebase config — valores hardcoded como fallback
// VITE_* vars no están disponibles en Node.js (son solo para el browser via import.meta.env)
const cfg = {
...
// Este SW es el que iOS Safari usa para recibir notificaciones push en background.
// Debe tener la configuración completa de Firebase Y toda la lógica de notificaciones.
const sw = `
...
console.log('✅ firebase-messaging-sw.js generado correctamente (iOS-ready)');
