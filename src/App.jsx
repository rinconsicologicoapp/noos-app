                      ...
                      <div style={{ flex:1, overflowY:"auto", position:"relative",
                        ...
                        <div style={{ padding:`${LINE_H}px 16px 24px 64px`, position:"relative", zIndex:3 }}>
                          ...
                          <div style={{ marginBottom:LINE_H, lineHeight:`${LINE_H}px` }}>
                            <div style={{ fontSize:22,fontWeight:900,color:"#2C1A0E",
          ...
          {!notifPanel && screen === "admin-paciente" && (
            <div style={{ height:"100%", overflowY:"auto", paddingBottom:"calc(140px + env(safe-area-inset-bottom, 0px))" }}>
              ...
              <div style={{ padding:14, paddingBottom:"calc(100px + env(safe-area-inset-bottom, 24px))" }}>
                ...
                {mitem(<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#8B5A3A" strokeWidth="1.75" strokeLinecap="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>, "Programar notificación", () => setModal("programar-notif"))}
